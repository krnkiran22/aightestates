    ...
    <section className="py-24 bg-brand-black px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          className="flex justify-between items-end mb-16 flex-wrap gap-8"
        >
          <div>
            <h2 className="text-5xl font-bold leading-tight text-white">
              Unsere<br />
              <span className="text-brand-orange">Leistungen</span>
            </h2>
          </div>
          <p className="text-brand-orange font-mono text-sm uppercase tracking-wider">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <motion.div
              ...
              className="p-10 rounded-3xl bg-brand-surface border border-white/5 hover:border-brand-orange/50 transition-all group relative overflow-hidden"
            >
              {/* Highlight Badge */}
              ...
              <ul className="space-y-4 mb-12">
                {service.features.map((feature, featureIndex) => (
                  <li key={featureIndex} className="flex items-start text-brand-muted">
              ...
              {/* CTA */}
              <button className="w-full py-4 border border-white/10 rounded-xl hover:bg-brand-orange hover:border-brand-orange transition-all group/btn text-white font-semibold">
        ...
        <motion.div
          ...
          className="mt-20"
        >
          <div className="bg-brand-orange rounded-[3rem] p-12 md:p-20 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="#kontakt"
                className="inline-block bg-white text-brand-orange px-12 py-5 rounded-full text-xl font-bold hover:scale-105 transition-transform"
              >
